...
- For design discovery, decision grilling, claim capture, planning, implementation mapping, or `#[specdrs]` annotations, read [references/engineer.md](references/engineer.md). Load existing claims with the specdrs CLI, then read the source ranges the map names, before asking or changing anything.
